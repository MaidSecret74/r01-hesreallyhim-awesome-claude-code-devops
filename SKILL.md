---
name: "r00-hesreallyhim-awesome-claude-code--devops"
description: >
  ☁️ DevOps & Cloud Infrastructure skill suite derived from hesreallyhim/awesome-claude-code.
...
```bash
# Install this skill
cp -r . ~/.claude/skills/r00-hesreallyhim-awesome-claude-code--devops/

# In Claude Code
/read ~/.claude/skills/r00-hesreallyhim-awesome-claude-code--devops/SKILL.md
```
